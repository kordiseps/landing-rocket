...
namespace LandingRocket.Lib.Tests
{
    public class GroundTests
    {
        ...
        [Theory]
        [MemberData(nameof(Get_Params_For_Should_Get_Ok_For_Landing_For_One_Rocket))]
        ...
        public static IEnumerable<object[]> Get_Params_For_Should_Get_Ok_For_Landing_For_One_Rocket()
        {
        ...
        ///burasu
        [Theory]
        [MemberData(nameof(Get_Params_For_Should_Get_Out_Of_Platform_For_One_Rocket))]
        ...
        public static IEnumerable<object[]> Get_Params_For_Should_Get_Out_Of_Platform_For_One_Rocket()
        {
            int areaWidth = 20;
            int areaHeight = 20;
            var platformStart = new Coordinate(5, 5);
        ...
        [Theory]
        [MemberData(nameof(Get_Params_For_Should_Clash_For_Second_Rocket))]
        public void Should_Clash_For_Second_Rocket(
            Coordinate first, 
            Coordinate second)
        {
            var platformStart = new Coordinate(5, 5);
        ...
        public static IEnumerable<object[]> Get_Params_For_Should_Clash_For_Second_Rocket()
        {
            var coordinate = new Coordinate(15, 15);
            foreach (var nearCoordinate in coordinate.GetNeighboursAndSelf())
            {
        ...
        [Theory]
        [MemberData(nameof(Get_Params_For_Should_Get_Ok_For_Landing_For_Second_Rocket_After_First_Rocket_Queries_2_Times))]
        ...
        public static IEnumerable<object[]> Get_Params_For_Should_Get_Ok_For_Landing_For_Second_Rocket_After_First_Rocket_Queries_2_Times()
        {
            var platformStart = new Coordinate(10, 10);
            var platformEnd = new Coordinate(20, 20);

            var coordinate = new Coordinate(15, 15);

            var nearCoordinates = coordinate.GetNeighboursAndSelf().ToList();
